...
async def start(client, message):
    ...
    button=InlineKeyboardMarkup([[
        InlineKeyboardButton(" Developer ", url='https://telegram.me/F5_JUBA')
        ],[
        InlineKeyboardButton(' Updates', url='https://telegram.me/F5_JUBA'),
        InlineKeyboardButton(' Support', url='https://telegram.me/F5_JUBA')
        ],[
